...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    vars: {
      ...
      "--ring": "262 55% 58%",
      "--glow-primary": "262 55% 58%",
      "--glow-accent": "280 50% 62%",
  ...
  ── end Sunset original ───────────────────────────────────────────────── */
  {
    ...
    aiBubble: "linear-gradient(135deg, hsl(18,25%,18%), hsl(15,22%,15%))",
    vars: {
      "--background": "18 28% 12%",
      "--foreground": "20 15% 92%",
      "--card": "18 25% 17%",
      ...
      "--input": "18 22% 26%",
      "--primary": "28 85% 58%",
      "--primary-foreground": "18 28% 8%",
      "--ring": "28 85% 58%",
      "--glow-primary": "28 85% 58%",
      "--glow-accent": "42 70% 60%",
