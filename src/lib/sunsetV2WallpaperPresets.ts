...
export const sunsetV2WallpaperPresets: WallpaperPreset[] = [
  // ── 01  Starry River (Van Gogh) ─────────────────────────────────────────────
  {
    ...
    glassColor: "28 55% 20%",
    accentColor: { primary: "32 72% 55%", secondary: "30 22% 62%", input: "28 25% 55%", border: "28 28% 18%" },
  ...
  // ── 02  Wildflower Path (Monet) ─────────────────────────────────────────────
  {
    ...
    glassColor: "12 52% 18%",
    accentColor: { primary: "15 65% 58%", secondary: "12 22% 65%", input: "10 25% 58%", border: "345 25% 20%" },
  ...
  // ── 03  Romantic Dusk (Classical) ───────────────────────────────────────────
  {
    ...
    glassColor: "25 58% 18%",
    accentColor: { primary: "38 80% 52%", secondary: "32 22% 62%", input: "30 25% 55%", border: "22 30% 16%" },
  ...
  // ── 04  Dreamtime Sun (Aboriginal) ─────────────────────────────────────────
  {
    ...
    glassColor: "5 60% 18%",
    accentColor: { primary: "30 78% 52%", secondary: "15 22% 64%", input: "12 25% 56%", border: "5 35% 16%" },
