...
export const sunsetV2WallpaperPresets: WallpaperPreset[] = [
  // ── 01  Starry River (Van Gogh) ─────────────────────────────────────────────
  {
    ...
    glassColor: "28 55% 20%",
    accentColor: { primary: "32 72% 55%", secondary: "35 45% 65%", input: "30 30% 26%", border: "28 28% 18%" },
  ...
  // ── 02  Wildflower Path (Monet) ─────────────────────────────────────────────
  {
    ...
    glassColor: "12 52% 18%",
    accentColor: { primary: "15 65% 58%", secondary: "350 40% 68%", input: "355 28% 28%", border: "345 25% 20%" },
  ...
  // ── 03  Romantic Dusk (Classical) ───────────────────────────────────────────
  {
    ...
    glassColor: "25 58% 18%",
    accentColor: { primary: "38 80% 52%", secondary: "28 50% 62%", input: "25 35% 24%", border: "22 30% 16%" },
  ...
  // ── 04  Dreamtime Sun (Aboriginal) ─────────────────────────────────────────
  {
    ...
    glassColor: "5 60% 18%",
    accentColor: { primary: "30 78% 52%", secondary: "10 55% 64%", input: "8 38% 25%", border: "5 35% 16%" },
  ...
  // ── 05  Cubist Dusk (Cubist) ────────────────────────────────────────────────
  {
    ...
    accentColor: { primary: "200 55% 55%", secondary: "210 40% 66%", input: "215 25% 25%", border: "210 22% 18%" },
